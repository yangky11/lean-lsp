        ...
        if (selectedText === "sorry") {
          vscode.window
            ...
            .then((apiKey) => {
              ...
              const lean4Extension =
                vscode.extensions.getExtension("leanprover.lean4");
              // Assert that the Lean 4 extension is installed
              if (!lean4Extension) {
                vscode.window.showErrorMessage(
                  "Lean 4 extension is not installed"
                );
                return;
              }
              lean4Extension.exports.lean4EnabledFeatures.then(
                (features: any) => {
